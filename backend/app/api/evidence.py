...
def get_evidence_package_report(
    ...
    if pkg.contains_simulated_data:
        ...
        <div class="simulated-warning">
            ...
            Demonstration data generated by the AlgaeMRV simulation engine.
        </div>
        """
...
def create_review_action(
    ...
    new_action = models.ReviewAction(
        package_id=pkg.id,
        actor="reviewer@algaemrv.com", # Mocking the actor since we don't have auth context in this snippet yet
